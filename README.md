...
[![Coles Price Tracker](https://img.shields.io/badge/Coles%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://bright.cn/products/insights/price-tracker/coles)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://bright.cn/products/insights/price-tracker/coles)

实时 Coles 价格追踪——澳大利亚两大连锁超市之一。两种入门方式：**全托管**情报平台，或使用 Bright Data 的 AI Scraper Builder 构建的**自定义 scraper**。

---

## 选项 1：Bright Insights - AI 驱动的价格追踪（推荐）

**[Bright Insights](https://bright.cn/products/insights/price-tracker/coles)** 是 Bright Data 的全托管零售情报平台。无需构建 scraper，无需维护基础设施——只需将结构化、可直接分析的价格数据交付到仪表板、数据源或您的 BI 工具中。
...
> **每月 $250 起 - [获取定制报价 →](https://bright.cn/products/insights/price-tracker/coles)**

---

## 选项 2：构建您自己的 Coles scraper

没有预构建的 Coles scraper API？没问题。Bright Data 的 **AI Scraper Builder** 只需点击几下即可生成自定义 Coles scraper——无需编写代码。

### 几分钟内构建您的 Coles scraper

**[打开 Coles AI Scraper Builder →](https://bright.cn/products/web-scraper/coles)**
...
构建完成后，您的 scraper 会获得一个 **Web Scraper ID** (`gd_xxxxxxxxxxxx`)——请复制它，用于下面的设置步骤。
...
- 一个用于 Coles 的 **Web Scraper ID**（来自上面的构建步骤）
...
1. **克隆此 repository**
   ...
   ```bash
   git clone https://github.com/bright-cn/coles-price-tracker.git
...
3. **配置凭据**
   ...
   > **您的 Web Scraper ID**
   > 将您在 [AI Scraper Builder dashboard](https://bright.cn/products/web-scraper/coles) 中的 Web Scraper ID
...
构建好您的 Coles scraper 并在 `.env` 中配置好 Web Scraper ID 后，Python 接口的使用方式相同：

### 1. 按 URL 追踪特定产品

传入 Coles 产品 URL 列表以获取结构化价格数据：
...
- 🌟 [Coles Price Tracker - Bright Insights (Managed)](https://bright.cn/products/insights/price-tracker/coles)
- 🏗️ [Build a Coles Scraper](https://bright.cn/products/web-scraper/coles)
